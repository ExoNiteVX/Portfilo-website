...
const projects = [
  ...
  {
    title: "Advanced Auth & Inventory",
    description: "Core backend systems focusing on secure user data handling, session management, and relational database architecture.",
    tech: ["Python", "SQLite", "Security", "Backend"],
    github: "https://github.com/ExoNiteVX/Auth-System",
    demo: null,
  }
]
